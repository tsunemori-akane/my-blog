...
<Image src="/images/fundamental/gr_1.webp" height='400' width='700' alt="gr_1.webp" />
<br />
<Image src="/images/fundamental/gr_2.webp" height='400' width='700' alt="gr_2.webp" />

- non capture group 使用 `?:` 比如 `(?:\w+)`

<div className="grid grid-cols-2 gap-4">
  <div>
    <Image src="/images/fundamental/gr_3.webp" height='400' width='400' alt="gr_3.webp" />
  </div>
  <div>
    <Image src="/images/fundamental/gr_4.webp" height='400' width='400' alt="gr_4.webp" />
  </div>
</div>
